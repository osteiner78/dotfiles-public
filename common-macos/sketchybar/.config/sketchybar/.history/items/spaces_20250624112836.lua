...
local function update_spaces()
  sbar.exec("aerospace list-workspaces --all", function(spaces)
        ...
        if windows and windows:match("%S") then
          ...
          if not created_spaces[space_name] then
            ...
            space:subscribe("space_windows_change", function()
              add_windows(space, space_name)
              -- update_spaces() removed to prevent recursion and race conditions
            end)
          ...
          -- Remove space if it exists and is now empty
          if created_spaces[space_name] then
            created_spaces[space_name]:remove()
            created_spaces[space_name] = nil
          end
        end
      end)
    end
    -- Remove any spaces that are no longer present
    ...
    -- os.execute("sketchybar --reload") -- removed to prevent infinite reload loop
  end)
end
