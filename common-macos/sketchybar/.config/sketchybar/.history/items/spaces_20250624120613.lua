...
local function update_spaces()
  sbar.exec("aerospace query --focused-workspace", function(focused_output)
    local focused_ws = focused_output:match("^%s*(.-)%s*$")
    sbar.exec("aerospace list-workspaces --all", function(spaces)
      ...
      sbar.exec("aerospace list-windows --all --format %{workspace}:::%{app-name}", function(windows_output)
        ...
        for _, space_name in ipairs(non_empty) do
          ...
          local selected = (focused_ws == space_name)
...
local function debounce_update_spaces()
