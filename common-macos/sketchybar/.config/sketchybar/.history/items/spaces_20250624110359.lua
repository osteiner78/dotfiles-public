...
sbar.exec("aerospace list-workspaces", function(spaces)
  for space_name in spaces:gmatch "[^\r\n]+" do
    sbar.exec("aerospace list-windows --workspace " .. space_name, function(windows)
      if windows:gsub("%s+", "") ~= "" then -- Check if windows string is not empty or just whitespace
      ...
      end -- end if windows not empty
    end) -- end sbar.exec list-windows
  end -- end for space_name
end) -- end sbar.exec list-workspaces

sbar.exec("aerospace list-workspaces --empty exclude", function(spaces)
  for space_name in spaces:gmatch "[^\r\n]+" do
    sbar.exec("aerospace list-windows --workspace " .. space_name, function(windows)
      if windows:gsub("%s+", "") ~= "" then -- Check if windows string is not empty or just whitespace
        local space = sbar.add("item", "space." .. space_name, {
